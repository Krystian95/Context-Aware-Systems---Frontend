...
lyr_Traiettorie_0.setVisible(true);lyr_Puntidicampionamento_1.setVisible(true);lyr_OpenStreetMap_2.setVisible(true);
var layersList = [group_1Traiettorieutenti,lyr_OpenStreetMap_2];
