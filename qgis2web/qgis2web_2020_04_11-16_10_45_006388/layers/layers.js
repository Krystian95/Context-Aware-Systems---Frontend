...
lyr_OpenStreetMap_0.setVisible(true);lyr_Traiettorie_1.setVisible(true);lyr_Puntidicampionamento_2.setVisible(true);lyr_Traiettorie_3.setVisible(true);lyr_Puntidicampionamento_4.setVisible(true);lyr_Walk_5.setVisible(true);lyr_Car_6.setVisible(true);lyr_Bike_7.setVisible(true);lyr_Walk_8.setVisible(true);lyr_Car_9.setVisible(true);lyr_Bike_10.setVisible(true);
var layersList = [group_Mappa,group_Inbaseallutente,group_Inbaseallattivit,group_2Confinigeofence,group_3Intensitgeofence];
