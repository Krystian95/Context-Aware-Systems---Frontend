...
lyr_Traiettorie_0.setVisible(true);lyr_Puntidicampionamento_1.setVisible(true);lyr_Walk_2.setVisible(true);lyr_Car_3.setVisible(true);lyr_Bike_4.setVisible(true);lyr_OpenStreetMap_5.setVisible(true);
