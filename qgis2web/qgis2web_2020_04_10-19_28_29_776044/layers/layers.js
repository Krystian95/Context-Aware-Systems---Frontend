...
lyr_OpenStreetMap_0.setVisible(true);lyr_Areacluster_1.setVisible(true);lyr_Centroidi_2.setVisible(true);lyr_Punticlusterizzati_3.setVisible(true);lyr_Punti_4.setVisible(true);
