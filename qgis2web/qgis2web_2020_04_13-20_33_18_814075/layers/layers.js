...
var lyr_Areacluster4_9 = new ol.layer.Vector({
                ...
                style: [style_Areacluster4_9,Point],
                interactive: true,
...
var format_Areacluster5c_17 = new ol.format.GeoJSON();
var features_Areacluster5c_17 = format_Areacluster5c_17.readFeatures(json_Areacluster5c_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Areacluster5c_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Areacluster5c_17.addFeatures(features_Areacluster5c_17);
var lyr_Areacluster5c_17 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Areacluster5c_17, 
                style: style_Areacluster5c_17,
                interactive: true,
                title: '<img src="styles/legend/Areacluster5c_17.png" /> Area cluster5c'
            });
...
var format_Areacluster5b_21 = new ol.format.GeoJSON();
var features_Areacluster5b_21 = format_Areacluster5b_21.readFeatures(json_Areacluster5b_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Areacluster5b_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Areacluster5b_21.addFeatures(features_Areacluster5b_21);
var lyr_Areacluster5b_21 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Areacluster5b_21, 
                style: style_Areacluster5b_21,
                interactive: true,
                title: '<img src="styles/legend/Areacluster5b_21.png" /> Area cluster5b'
            });
...
var format_Areacluster5dw_25 = new ol.format.GeoJSON();
var features_Areacluster5dw_25 = format_Areacluster5dw_25.readFeatures(json_Areacluster5dw_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Areacluster5dw_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Areacluster5dw_25.addFeatures(features_Areacluster5dw_25);
var lyr_Areacluster5dw_25 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Areacluster5dw_25, 
                style: style_Areacluster5dw_25,
                interactive: true,
                title: '<img src="styles/legend/Areacluster5dw_25.png" /> Area cluster5dw'
            });
...
var format_Areacluster5dc_29 = new ol.format.GeoJSON();
var features_Areacluster5dc_29 = format_Areacluster5dc_29.readFeatures(json_Areacluster5dc_29, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Areacluster5dc_29 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Areacluster5dc_29.addFeatures(features_Areacluster5dc_29);
var lyr_Areacluster5dc_29 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Areacluster5dc_29, 
                style: style_Areacluster5dc_29,
                interactive: true,
                title: '<img src="styles/legend/Areacluster5dc_29.png" /> Area cluster5dc'
            });
...
var format_Areacluster5db_33 = new ol.format.GeoJSON();
var features_Areacluster5db_33 = format_Areacluster5db_33.readFeatures(json_Areacluster5db_33, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Areacluster5db_33 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Areacluster5db_33.addFeatures(features_Areacluster5db_33);
var lyr_Areacluster5db_33 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Areacluster5db_33, 
                style: style_Areacluster5db_33,
                interactive: true,
                title: '<img src="styles/legend/Areacluster5db_33.png" /> Area cluster5db'
            });
...
var group_Bike = new ol.layer.Group({
                                layers: [lyr_Areacluster5b_21,lyr_Punticlusterizzati_22,lyr_Punti_23,lyr_Geofenceesistenti_24,],
                                title: "Bike"});
var group_Car = new ol.layer.Group({
                                layers: [lyr_Areacluster5c_17,lyr_Punticlusterizzati_18,lyr_Punti_19,lyr_Geofenceesistenti_20,],
                                title: "Car"});
var group_Walk = new ol.layer.Group({
                                layers: [lyr_Areacluster5w_13,lyr_Punticlusterizzati_14,lyr_Punti_15,lyr_Geofenceesistenti_16,],
                                title: "Walk"});
...
lyr_OpenStreetMap_0.setVisible(true);lyr_Traiettorie_1.setVisible(true);lyr_Puntidicampionamento_2.setVisible(true);lyr_Walk_3.setVisible(true);lyr_Car_4.setVisible(true);lyr_Bike_5.setVisible(true);lyr_Walk_6.setVisible(true);lyr_Car_7.setVisible(true);lyr_Bike_8.setVisible(true);lyr_Areacluster4_9.setVisible(true);lyr_Centroidi_10.setVisible(true);lyr_Punticlusterizzati_11.setVisible(true);lyr_Punti_12.setVisible(true);lyr_Areacluster5w_13.setVisible(true);lyr_Punticlusterizzati_14.setVisible(true);lyr_Punti_15.setVisible(true);lyr_Geofenceesistenti_16.setVisible(true);lyr_Areacluster5c_17.setVisible(true);lyr_Punticlusterizzati_18.setVisible(true);lyr_Punti_19.setVisible(true);lyr_Geofenceesistenti_20.setVisible(true);lyr_Areacluster5b_21.setVisible(true);lyr_Punticlusterizzati_22.setVisible(true);lyr_Punti_23.setVisible(true);lyr_Geofenceesistenti_24.setVisible(true);lyr_Areacluster5dw_25.setVisible(true);lyr_Punticlusterizzati_26.setVisible(true);lyr_Punti_27.setVisible(true);lyr_Geofenceesistenti_28.setVisible(true);lyr_Areacluster5dc_29.setVisible(true);lyr_Punticlusterizzati_30.setVisible(true);lyr_Punti_31.setVisible(true);lyr_Geofenceesistenti_32.setVisible(true);lyr_Areacluster5db_33.setVisible(true);lyr_Punticlusterizzati_34.setVisible(true);lyr_Punti_35.setVisible(true);lyr_Geofenceesistenti_36.setVisible(true);
var layersList = [group_Mappa,group_1Traiettorieutenti,group_2Confinigeofence,group_3Intensitgeofence,group_4Posizioniecluster,group_Walk,group_Car,group_Bike,lyr_Areacluster5dw_25,lyr_Punticlusterizzati_26,lyr_Punti_27,lyr_Geofenceesistenti_28,lyr_Areacluster5dc_29,lyr_Punticlusterizzati_30,lyr_Punti_31,lyr_Geofenceesistenti_32,lyr_Areacluster5db_33,lyr_Punticlusterizzati_34,lyr_Punti_35,lyr_Geofenceesistenti_36];
...
lyr_Areacluster5c_17.set('fieldAliases', {'centroid': 'centroid', 'number_points': 'number_points', 'geom_of_centroid': 'geom_of_centroid', });
...
lyr_Areacluster5b_21.set('fieldAliases', {'centroid': 'centroid', 'number_points': 'number_points', 'geom_of_centroid': 'geom_of_centroid', });
...
lyr_Areacluster5dw_25.set('fieldAliases', {'centroid': 'centroid', 'number_points': 'number_points', 'geom_of_centroid': 'geom_of_centroid', });
...
lyr_Areacluster5dc_29.set('fieldAliases', {'centroid': 'centroid', 'number_points': 'number_points', 'geom_of_centroid': 'geom_of_centroid', });
...
lyr_Areacluster5db_33.set('fieldAliases', {'centroid': 'centroid', 'number_points': 'number_points', 'geom_of_centroid': 'geom_of_centroid', });
...
lyr_Areacluster5c_17.set('fieldImages', {'centroid': '', 'number_points': '', 'geom_of_centroid': '', });
...
lyr_Areacluster5b_21.set('fieldImages', {'centroid': '', 'number_points': '', 'geom_of_centroid': '', });
...
lyr_Areacluster5dw_25.set('fieldImages', {'centroid': '', 'number_points': '', 'geom_of_centroid': '', });
...
lyr_Areacluster5dc_29.set('fieldImages', {'centroid': '', 'number_points': '', 'geom_of_centroid': '', });
...
lyr_Areacluster5db_33.set('fieldImages', {'centroid': '', 'number_points': '', 'geom_of_centroid': '', });
