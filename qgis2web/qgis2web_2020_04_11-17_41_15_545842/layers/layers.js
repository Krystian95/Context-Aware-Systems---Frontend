...
var lyr_Areacluster_5 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Areacluster_5_0.png" /> 0<br />\
    <img src="styles/legend/Areacluster_5_1.png" /> 1<br />\
    <img src="styles/legend/Areacluster_5_2.png" /> 2<br />\
    <img src="styles/legend/Areacluster_5_3.png" /> 3<br />\
    <img src="styles/legend/Areacluster_5_4.png" /> 4<br />\
    <img src="styles/legend/Areacluster_5_5.png" /> 5<br />\
    <img src="styles/legend/Areacluster_5_6.png" /> <br />'
        });
var format_Centroidi_6 = new ol.format.GeoJSON();
var features_Centroidi_6 = format_Centroidi_6.readFeatures(json_Centroidi_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Centroidi_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Centroidi_6.addFeatures(features_Centroidi_6);
var lyr_Centroidi_6 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Centroidi_6, 
                style: style_Centroidi_6,
                interactive: false,
    title: 'Centroidi<br />\
    <img src="styles/legend/Centroidi_6_0.png" /> 0<br />\
    <img src="styles/legend/Centroidi_6_1.png" /> 1<br />\
    <img src="styles/legend/Centroidi_6_2.png" /> 2<br />\
    <img src="styles/legend/Centroidi_6_3.png" /> 3<br />\
    <img src="styles/legend/Centroidi_6_4.png" /> 4<br />\
    <img src="styles/legend/Centroidi_6_5.png" /> 5<br />\
    <img src="styles/legend/Centroidi_6_6.png" /> <br />'
        });
var format_Punticlusterizzati_7 = new ol.format.GeoJSON();
var features_Punticlusterizzati_7 = format_Punticlusterizzati_7.readFeatures(json_Punticlusterizzati_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Punticlusterizzati_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Punticlusterizzati_7.addFeatures(features_Punticlusterizzati_7);
var lyr_Punticlusterizzati_7 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Punticlusterizzati_7, 
                style: style_Punticlusterizzati_7,
                interactive: false,
    title: 'Punti clusterizzati<br />\
    <img src="styles/legend/Punticlusterizzati_7_0.png" /> 0<br />\
    <img src="styles/legend/Punticlusterizzati_7_1.png" /> 1<br />\
    <img src="styles/legend/Punticlusterizzati_7_2.png" /> 2<br />\
    <img src="styles/legend/Punticlusterizzati_7_3.png" /> 3<br />\
    <img src="styles/legend/Punticlusterizzati_7_4.png" /> 4<br />\
    <img src="styles/legend/Punticlusterizzati_7_5.png" /> 5<br />\
    <img src="styles/legend/Punticlusterizzati_7_6.png" /> <br />'
        });
var format_Punti_8 = new ol.format.GeoJSON();
var features_Punti_8 = format_Punti_8.readFeatures(json_Punti_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Punti_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Punti_8.addFeatures(features_Punti_8);
var lyr_Punti_8 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Punti_8, 
                style: style_Punti_8,
                interactive: false,
                title: '<img src="styles/legend/Punti_8.png" /> Punti'
            });
var group_4Posizioniecluster = new ol.layer.Group({
                                layers: [lyr_Areacluster_5,lyr_Centroidi_6,lyr_Punticlusterizzati_7,lyr_Punti_8,],
...
lyr_OpenStreetMap_0.setVisible(true);lyr_Traiettorie_1.setVisible(false);lyr_Puntidicampionamento_2.setVisible(false);lyr_Traiettorie_3.setVisible(false);lyr_Puntidicampionamento_4.setVisible(false);lyr_Areacluster_5.setVisible(false);lyr_Centroidi_6.setVisible(false);lyr_Punticlusterizzati_7.setVisible(false);lyr_Punti_8.setVisible(false);
var layersList = [group_Mappa,group_Inbaseallutente,group_Inbaseallattivit,group_4Posizioniecluster];
...
lyr_Centroidi_6.set('fieldAliases', {'centroid': 'centroid', 'number_points': 'number_points', 'area_of_cluster': 'area_of_cluster', });
lyr_Punticlusterizzati_7.set('fieldAliases', {'id': 'id', 'user_id': 'user_id', 'cluster_id': 'cluster_id', });
lyr_Punti_8.set('fieldAliases', {'id': 'id', 'user_id': 'user_id', 'date_time': 'date_time', });
...
lyr_Areacluster_5.set('fieldImages', {'centroid': 'Range', 'number_points': 'TextEdit', 'geom_of_centroid': '', });
lyr_Centroidi_6.set('fieldImages', {'centroid': 'Range', 'number_points': 'TextEdit', 'area_of_cluster': '', });
lyr_Punticlusterizzati_7.set('fieldImages', {'id': '', 'user_id': '', 'cluster_id': '', });
lyr_Punti_8.set('fieldImages', {'id': '', 'user_id': '', 'date_time': '', });
...
lyr_Centroidi_6.set('fieldLabels', {});
lyr_Punticlusterizzati_7.set('fieldLabels', {});
lyr_Punti_8.set('fieldLabels', {});
lyr_Punti_8.on('precompose', function(evt) {
